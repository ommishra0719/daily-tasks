"""Day 36 — Conversational RAG with LangChain LCEL, streamed over FastAPI SSE."""
...
# reformulates follow-ups ("do I need approval for that?") into standalone questions
# using chat history, before retrieval runs
...
async def stream_answer(request: ChatRequest) -> AsyncGenerator[str, None]:
    """Streams the RAG chain's answer tokens as Server-Sent Events."""
...
if __name__ == "__main__":
    # sanity check: follow-up must reuse chat history via the history-aware retriever
