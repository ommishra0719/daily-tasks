"""
Multi-Query Retrieval: generate N rephrased query variants with Gemini,
retrieve top-K for each, deduplicate by content hash, return merged set.
...
# ==========================================
# 3. Multi-query retrieval with deduplication
# ==========================================
...
# ==========================================
# 4. Recall comparison across 5 test queries
# ==========================================
TEST_QUERIES = [
